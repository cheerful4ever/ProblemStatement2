...
public class holidayAdapter extends ArrayAdapter<HolidayDate> {
    private ArrayList<HolidayDate> holiday;
    private Context context;
    private TextView tvName;
    private TextView tvDate;
    private ImageView ivHoliday;

    public holidayAdapter(Context context, int resource, ArrayList<HolidayDate> objects){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        HolidayDate currentHoliday = holiday.get(position);
