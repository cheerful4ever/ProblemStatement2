...
public class Holiday extends AppCompatActivity {
    ...
    ArrayList<HolidayDate> holiday1;
    ArrayList<HolidayDate> holiday2;
...
// Create a few food objects in Food array
        holiday1 = new ArrayList<HolidayDate>();
        holiday1.add(new HolidayDate("New Year's Day", "1 Jan 2017",
                "New Year's Day is a public holiday in Singapore. ... Singapore" +
                        ...
                        " of January."));
        holiday1.add(new HolidayDate("Labour Day", "1 May 2017", "In Singapore," +
        ...
        holiday2 = new ArrayList<HolidayDate>();
        holiday2.add(new HolidayDate("Chinese New Year", "28-29 Jan 2017",
        ...
        holiday2.add(new HolidayDate("Good Friday", "14 April 2017", "Good Friday," +
        ...
        if (type == "Secular") {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    HolidayDate selectedHoliday = holiday1.get(position);

                    Toast.makeText(Holiday.this, selectedHoliday.getName()
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    HolidayDate selectedHoliday = holiday2.get(position);
